angular.module('templates-main', ['../../app/views/backlogs/item.tpl.html', '../../app/views/backlogs/list.tpl.html', '../../app/views/backlogs/main.tpl.html', '../../app/views/backlogs/new.tpl.html', '../../app/views/common/body.tpl.html', '../../app/views/common/footer.tpl.html', '../../app/views/common/heading.tpl.html', '../../app/views/common/toolbar.tpl.html', '../../app/views/dashboard/main.tpl.html', '../../app/views/projects/edit.tpl.html', '../../app/views/projects/item.tpl.html', '../../app/views/projects/list.tpl.html', '../../app/views/projects/main.tpl.html', '../../app/views/sprints/main.tpl.html']);

angular.module("../../app/views/backlogs/item.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/backlogs/item.tpl.html",
    "<div>\n" +
...
angular.module("../../app/views/backlogs/list.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/backlogs/list.tpl.html",
    "<div>\n" +
...
angular.module("../../app/views/backlogs/main.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/backlogs/main.tpl.html",
    "<div class=\"container\">\n" +
...
angular.module("../../app/views/backlogs/new.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/backlogs/new.tpl.html",
    "<div>\n" +
    "    <span class=\"pull-right\"></span>\n" +
    "    <h3>\n" +
    "        Create New Backlog\n" +
...
angular.module("../../app/views/common/body.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/common/body.tpl.html",
    "<div class=\"app-body\">\n" +
    "    <div ui-view=\"main\"></div>\n" +
    "</div>");
}]);

angular.module("../../app/views/common/footer.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/common/footer.tpl.html",
    "<div class=\"app-footer\">\n" +
    "    This is a Sample AngularJS application built for demo purposes only...\n" +
    "</div>");
}]);

angular.module("../../app/views/common/heading.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/common/heading.tpl.html",
    "<pre>Heading</pre>");
}]);

angular.module("../../app/views/common/toolbar.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/common/toolbar.tpl.html",
...
angular.module("../../app/views/dashboard/main.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/dashboard/main.tpl.html",
    "<div class=\"container\">\n" +
    "    <div class=\"app-caption\">\n" +
    "        <h2>\n" +
...
angular.module("../../app/views/projects/edit.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/projects/edit.tpl.html",
    "<div>\n" +
    "    <span class=\"pull-right\">\n" +
...
angular.module("../../app/views/projects/item.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/projects/item.tpl.html",
    "<div>\n" +
    "    <span class=\"pull-right\">\n" +
...
angular.module("../../app/views/projects/list.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/projects/list.tpl.html",
    "<div>\n" +
    "    <p>\n" +
...
angular.module("../../app/views/projects/main.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/projects/main.tpl.html",
    "<div class=\"container\">\n" +
    "    <div class=\"app-caption\">\n" +
    "        <h2>\n" +
...
angular.module("../../app/views/sprints/main.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../../app/views/sprints/main.tpl.html",
    "<div class=\"container\">\n" +
    "    <div class=\"app-caption\">\n" +
    "        <h2>\n" +
